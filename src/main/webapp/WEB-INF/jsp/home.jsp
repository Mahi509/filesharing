...
<body>
	...
	<p id="list">
		<span id="glymp" class="glyphicon glyphicon-headphones"> Music</span>
		<span id="glymp" class="glyphicon glyphicon-file"> Files</span> <span
			id="glymp" class="glyphicon glyphicon-film"> Video</span> <span
			id="glymp" class="glyphicon glyphicon-camera"> Photo</span> <span
			id="glymp" class="glyphicon glyphicon-facetime-video"> Videos
		</span> <span id="glymp" class="glyphicon glyphicon-book"> Books</span>
	</p>
	...
	<!-- <input type="file" id="upload" value="UPLOAD YOUR DATA" onclick=""> -->
