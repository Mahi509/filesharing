				...
				<form id="reg-form">
					...
					<div id="left">
						...
						<input type="text" id="firstName" name="firstName"
							...
							title="FirstName goes here" /> <label for="firstName"
							generated="true" class="error" style="color: red"></label>
					...
					<div id="left">
						...
						<input type="text" id="lastName" name="lastName"
							...
							title="LastName goes here" /> <label for="lastName"
							generated="true" class="error" style="color: red"></label>
					</div>
					...
					<div id="left">
						...
						<input type="text" id="username" name="username"
							...
							title="UserName goes here" /> <label for="username"
							generated="true" class="error" style="color: red"></label>
					</div>
					<div id="left">
						<label for="password">Password<sup style="color: red;">*</sup></label>
						<input type="password" name="password" id="password"
							title="Password goes here" /> <label for="password"
							generated="true" class="error" style="color: red"></label>
					</div>
					<div id="right">
						<label for="confirmpassword">Confirm Password <sup
							...
							title="ConfirmPassword goes here" /> <label
					...
					<div id="email">
						<label for="email">Email<sup style="color: red;">*</sup></label> <input
							...
							placeholder="abc@xyz.com" title="Email goes here" /> <label
							for="email" generated="true" class="error" style="color: red"></label>
					</div>
